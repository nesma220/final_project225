...
class PlumbingPage extends StatelessWidget {
  ...
  PlumbingPage({super.key,required  this.serviceName, required this.serviceData});
  @override
    ...
    return Scaffold(
      ...
      body: Obx(
        () => SingleChildScrollView(
          ...
          child: Column(
            children: bookmarkController.services.where((service) => service['category'] == 'Plumbing').map((service) {
              return ServiceItem(
